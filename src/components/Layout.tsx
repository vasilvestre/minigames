            ...
            {status === "loading" ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-lg px-3 py-2 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 hover:text-foreground"
                >
                  Déconnexion
                </button>
              </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              {session?.user && (
                <button
                  ...
                  className="rounded-lg px-4 py-3 text-left text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 hover:text-foreground"
                >
                  Déconnexion
                </button>
              )}
